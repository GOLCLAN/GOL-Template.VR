...
_weaponCamo = {
	switch (_this select 0) do {
	    default {
			...
			// Rifleman AT
			_LAT = "tf47_m3maaws";
			_LATmag = "tf47_m3maaws_HEDP";

			// Rifleman AT
			_MAT = "tf47_m3maaws";
			_MATmag1 = "tf47_m3maaws_HEDP";
...
_camoflage = {
	switch (_this select 0) do {
	    default {
			// Infantry
			_baseHelmet = ["IDF_Helmet_CQB_1","IDF_Helmet_CQB_5","IDF_Helmet_Mitsnefet_3","IDF_Helmet_Mitsnefet_1","IDF_Helmet_Mitsnefet_2"] call BIS_fnc_selectRandom;
