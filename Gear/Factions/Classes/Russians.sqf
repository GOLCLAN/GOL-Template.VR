...
switch (GOL_Gear_Camo) do {
    case 1: {	// Desert
		...
		// Infantry
		_baseHelmet = ["rhs_6b27m_green_bala"] call BIS_fnc_selectRandom;
		_baseUniform = ["rhs_uniform_vdv_mflora"] call BIS_fnc_selectRandom;
		_baseVest = ["rhs_6b23_ML_6sh92"] call BIS_fnc_selectRandom;
