...
// *
// *	Usage:
// *		["TESTARRAY",["O_MBT_02_arty_F",4.87696e-005,[447.058,1296.36,-0.00276756]]] call GVL_Fnc_CreateObjects;
// *
// *	Parameters:
	...
	_this spawn {
...

		{
			...
			if (!isMultiplayer) then {
				GVL_ZeuzModuleAdminLogged addCuratorEditableObjects [[_veh],true];
			};
		} forEach _Objects;
