...
// *
// *	Returning Value:
// *		Array: Code to be used together with the function GVL_Fnc_CreateObjects
// *
// ================================================================
	...
	_DebugName = "GVL-CopyObjects";
	scriptName _DebugName;

	_Objects = curatorEditableObjects GVL_ZeuzModuleAdminLogged;
	_positionsCopyed = {
		[["%1 Buildings Copied",(count _CopyObjects)],[_DebugName,__FILE__,__LINE__],"both"] call GVL_Fnc_DebugLog;
