...
// ================================================================
	...
	switch (side _unit) do {
		...
		case sideEnemy: {
			...
			_returnValue = [_unit] call GVL_Fnc_GetSide;
		};

		default {
			_DebugName = "GVL_Fnc_GetSide";
			scriptName _DebugName;
			[["%1 No respawn maker assigned/found!", (typeName _unit)],[_DebugName,__FILE__,__LINE__],"log"] call GVL_Fnc_DebugLog;
		};
