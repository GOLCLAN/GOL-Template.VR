	...
	_asr = str(["ASR_Config"] call GVL_Fnc_GetConfig);
	_aiFaction = str(["Default_AI"] call GVL_Fnc_GetConfig);
// ================================================================
	_factionWest = str(["Gear", "Blufor"] call GVL_Fnc_GetConfig);
	_factionEast = str(["Gear", "Opfor"] call GVL_Fnc_GetConfig);
	_factionIndep = str(["Gear", "Independent"] call GVL_Fnc_GetConfig);
...
// ================================================================
	...
	_Credits = "
		...
		<br/>	==============================================
		<br/>
		<br/>	Framework by: "+GVL_Author+"
		<br/>	Version: "+GVL_Version+"
		<br/>
		<br/>	==============================================
		<br/>
		<br/>	Guerrillas of Liberation
		<br/>	Teamspeak: "+GVL_Teamspeak+"
		<br/>	Website: "+GVL_url+"
		<br/>
		<br/>	==============================================
		<br/>";
	...
	#define Fnc_getVariables(Var,DiaryName)\
		private ["_modulesAGM","_count","_string","_value","_modulesArray","_notesAGM","_ignore"];\
		_modulesAGM = [];\
		...
		for "_i" from 0 to (_count - 1) do {\
			...
			if !(_string in _ignore) then {\
				diag_log format ["%1: %2 <br/>", _string, _value];\
				_modulesAGM pushBack formatText ["%1: %2 <br/>", _string, _value];\
			};\
		};\
		_modulesArray = format ["%1", _modulesAGM]; \
		_notesAGM = "<br/>	"+ _modulesArray;\
		player createDiaryRecord ["Log", [DiaryName,_notesAGM]];
