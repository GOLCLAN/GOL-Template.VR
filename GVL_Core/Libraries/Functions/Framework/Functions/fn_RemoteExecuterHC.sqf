...
// *
// *	Usage:
// *		["What to be Executed","how it show be executed",[Params for what being executed]] call GVL_fnc_RemoteExecuterHC;
// *		[GVL_fnc_AI_Inf_Group,"call",["Spawn", 3, "defend", ["obj_1", 50, false], true, 0.3]] call GVL_fnc_RemoteExecuterHC;
// *		[GVL_fnc_AI_Inf_Group,"call",["Spawn", 3, "patrol", ["obj_1", 50, 10], true, 0.3]] call GVL_fnc_RemoteExecuterHC;
// *
// *	Parameters:
