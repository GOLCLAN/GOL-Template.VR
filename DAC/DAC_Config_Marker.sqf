...
private ["_MarkerConfig","_MarkerSet","_s","_setShowZones","_setShowWPs","_setShowUnit","_setGroupType",
...
_MarkerSet = 	["_setShowZones","_setShowWPs","_setShowUnit","_setGroupType","_setMarkerText",
