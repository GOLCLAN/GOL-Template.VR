//	[player, systemChat "Pilot: Awaiting coordinates"] onMapSingleClick {[blufor,"","drop",["spawn",_pos,"despawn"],["wp1"],["wp2"],"",false] execVM "Scripts\NEKY_Supply\NEKY_SupplyInit.sqf"};
//	
...
_BoxCode = [_This, 6, "Scripts\NEKY_Supply\NEKY_SupplyBox.sqf", ["", {}]] call BIS_fnc_Param;
_Vulnerable = [_This, 7, false, [false]] call BIS_fnc_Param;

//	Run main script
[[[_Side,_HeliClass,_Type,_STDs,_Waypoints1,_Waypoints2,_BoxCode,_Vulnerable], "Scripts\NEKY_Supply\NEKY_Supply.sqf"], "BIS_fnc_ExecVM", false] call BIS_fnc_MP;
