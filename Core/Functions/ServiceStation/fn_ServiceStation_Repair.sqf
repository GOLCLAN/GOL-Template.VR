	Private ["_Refueling","_RearmSleep","_RearmSleepPlane","_FullService","_Driver","_RepairingSpeedPlane","_State","_Trigger","_RepairingSpeed","_PartsHP","_PartNames","_PartName","_InspectionSpeed","_Index","_FuelHP","_HullHP","_TurretHP","_GunHP","_VehicleHP","_MainRotorHP","_atrqHP","_InstrumentsHP","_Parts","_CarHullHP","_LeftTrackHP","_RightTrackHP"];
